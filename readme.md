...
> В аналитике учитываются только заказы со статусом «выполнен» (фактическая выручка).
...
> Индексы на бизнес-ключах хабов не дублируются: они покрываются UNIQUE-ограничениями. 
Составные PK сателлитов покрывают выбор последней версии. Оставлены только индексы на внешние ключи, не входящие в UNIQUE-ограничения.
