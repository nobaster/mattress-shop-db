...
>>>>>>> e23f4ef08e9289b86d089ae09f9d9d0f5b1e3ab0
Результат: план запроса меняется с полного перебора таблицы (Seq Scan) на точечный поиск по индексу (Index Scan). На промышленных объёмах данных это даёт ускорение в десятки и сотни раз.